...
\begin{figure}[ht]
  \begin{center}
    \scalebox{0.7}{\includegraphics{BioModelClass.jpg}}
...
modelData has class \Robject{exprSet}, and the \Robject{gseModel} class
...
\begin{figure}[ht]
  \begin{center}
    \scalebox{0.2}{\includegraphics{GSE.jpg}}
...
\begin{figure}[ht]
  \begin{center}
    \scalebox{0.7}{\includegraphics{BioViewClass.jpg}}
